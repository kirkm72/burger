let connection = require("./connection.js"); //use this connection
...
let orm = { // Object for all our SQL statement functions.
  ...
  update: function(table, objColVals, condition, cb) { //example of objColVals would be {burgerName: Baconburger, devoured: true}
